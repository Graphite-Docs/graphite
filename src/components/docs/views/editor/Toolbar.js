...
import fontOptions from './fontOptions.json.js';
import headingOptions from './headingOptions.json.js';
import fontSizeOptions from './fontSizeOptions.json.js';
import colorOptions from './colorOptions.json.js';
