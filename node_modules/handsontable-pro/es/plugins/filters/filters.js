  ...
  _createClass(Filters, [{
    ...
    value: function enablePlugin() {
      ...
      if (!this.components.get('filter_by_condition')) {
        var conditionComponent = new ConditionComponent(this.hot, { id: 'filter_by_condition', name: filterByConditionLabel, addSeparator: false });
      ...
      if (!this.components.get('filter_by_condition2')) {
        var _conditionComponent = new ConditionComponent(this.hot, { id: 'filter_by_condition2', name: '', addSeparator: true });
    ...
    value: function updateComponents(conditionsState) {
      ...
      if (conditionsByValue.length === 2 || conditionsWithoutByValue.length === 3) {
        console.warn(toSingleLine(_templateObject));
      } else {
