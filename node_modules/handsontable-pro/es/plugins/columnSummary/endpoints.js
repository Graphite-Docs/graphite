...
var Endpoints = function () {
  ...
  _createClass(Endpoints, [{
    ...
    value: function parseSettings(settings) {
      ...
      arrayEach(settings, function (val) {
        var newEndpoint = {};
    ...
    value: function resetSetupBeforeStructureAlteration(action, index, number, logicRows, source) {
      ...
      arrayEach(endpoints, function (val, key, obj) {
    ...
    value: function resetSetupAfterStructureAlteration(action, index, number, logicRows, source) {
      ...
      if (rowMoving) {
        arrayEach(endpoints, function (endpoint, key, obj) {
    ...
    value: function extendEndpointRanges(endpoint, placeOfAlteration, previousPosition, offset) {
      arrayEach(endpoint.ranges, function (range, i) {
    ...
    value: function shiftEndpointCoordinates(endpoint, offsetStartIndex) {
      if (endpoint.alterRowOffset && endpoint.alterRowOffset !== 0) {
        ...
        arrayEach(endpoint.ranges, function (element, i) {
    ...
    value: function resetAllEndpoints(endpoints) {
      ...
      arrayEach(endpoints, function (value) {
    ...
    value: function refreshChangedEndpoints(changes) {
      ...
      arrayEach(changes, function (value, key, changes) {
        // if nothing changed, dont update anything
        if ((value[2] || '') + '' === value[3] + '') {
          return;
        }

        arrayEach(_this6.getAllEndpoints(), function (value, j) {
