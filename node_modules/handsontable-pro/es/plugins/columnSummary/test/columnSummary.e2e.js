describe('ColumnSummarySpec', function () {
  ...
  var columnSummaryFunction = function columnSummaryFunction() {
    ...
    for (var i = 0; i < nestedRowsCache.levels[0].length; i++) {
      ...
      tempEndpoint.ranges.push([getRowIndex(nestedRowsCache.levels[0][i].__children[0]), getRowIndex(nestedRowsCache.levels[0][i].__children[nestedRowsCache.levels[0][i].__children.length - 1])]);
  ...
  describe('parseSettings', function () {
    it('should parse the settings from the Handsontable instance', function () {
      var customFunction = function customFunction() {
        var hi = null;
      };
      ...
      var endpoints = [plugin.endpoints.getEndpoint(0), plugin.endpoints.getEndpoint(1)];
    ...
    it('should apply a custom function to the entries in the provided range', function () {
      var hot = handsontable({
        ...
        columnSummary: [{
          ...
          ranges: [[0, 13]],
          type: 'custom',
          customFunction: function customFunction(endpoint) {
  ...
  describe('complex setups', function () {
    ...
    it('should accept endpoints configuration provided as a function', function () {
      var hot = handsontable({
        ...
        height: 200,
        width: 200,
        columnSummary: function columnSummary() {
          var config = [];
