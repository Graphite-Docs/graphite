  ...
  describe('API', function () {
    describe('collapseChildren', function () {
      it('should collapse all children nodes of the row provided as a number', function () {
        ...
        for (var _i = 0; _i < plugin.dataManager.countChildren(0); _i++) {
          expect(trimRowsPlugin.isTrimmed(_i + 1)).toEqual(true);
        }
      ...
      it('should collapse all children nodes of the row provided as an object', function () {
        ...
        for (var _i2 = 0; _i2 < plugin.dataManager.countChildren(0); _i2++) {
          expect(trimRowsPlugin.isTrimmed(_i2 + 1)).toEqual(true);
        }
