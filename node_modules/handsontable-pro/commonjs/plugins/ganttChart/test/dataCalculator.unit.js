...
var stdCache = null;
var disallowSplitWeeksCache = null;
beforeEach(function () {
...
describe('DateCalculator', function () {
  describe('the `setYear` method', function () {
    it('should set the year as a base for calculations', function () {
      var plugin = new _dateCalculator2.default(2017);
  ...
  describe('the `setFirstWeekDay` method', function () {
    it('should set the first week day', function () {
      var plugin = new _dateCalculator2.default(2017);
    ...
    it('should throw a warning if setting the first week day to something else than `monday` or `sunday`', function () {
      var plugin = new _dateCalculator2.default(2017);
  ...
  describe('the `parseDate` method', function () {
  ...
  describe('the `dateToColumn` method', function () {
    it('should return a column for a provided date (in string or Date format), when `allowSplitWeeks` is set to true (default)', function () {
      var plugin = new _dateCalculator2.default(2017);
    ...
    it('should return a column for a provided date (in string or Date format), when `allowSplitWeeks` is set to false', function () {
      var plugin = new _dateCalculator2.default(2017, false);
  ...
  describe('the `getWeekColumn` method', function () {
    it('should return a week column index for the provided day and month', function () {
      var plugin = new _dateCalculator2.default(2017);
    ...
    it('should return a week column index for the provided day and month, when `allowSplitWeeks` is set to false', function () {
      var plugin = new _dateCalculator2.default(2017, false);
  ...
  describe('the `getMonthCacheArray` method', function () {
    it('should get the cached information for the provided month', function () {
      var plugin = new _dateCalculator2.default(2017);

      // mock the day cache creation from the actual plugin:
      plugin.daysInColumns = stdCache;

      expect(plugin.getMonthCacheArray(2)).toEqual(JSON.parse('[{"11":[1,2,3,4,5],"12":[6,7,8,9,10,11,12],"13":' + '[13,14,15,16,17,18,19],"14":[20,21,22,23,24,25,26],"15":[27,28,29,30,31]}]'));
    });
  });

  describe('the `columnToDate` method', function () {
    it('should return a Date object for the provided column index, if the column represents a single date', function () {
      var plugin = new _dateCalculator2.default(2017);

      // mock the day cache creation from the actual plugin:
      plugin.daysInColumns = stdCache;

      var date = plugin.columnToDate(0);
      var properDate = new Date('01/01/2017');
    ...
    xit('should return an object with `start` and `end` properties representing a range of dates', function () {
      var plugin = new _dateCalculator2.default(2017);
    });
  });

  describe('the `isOnTheEdgeOfWeek` method', function () {
    it('should check whether the provided date is on the edge of the week', function () {
      var plugin = new _dateCalculator2.default(2017);
  ...
  describe('the `addDaysToCache` method', function () {
    it('should update the plugin cache with the provided information', function () {
      var plugin = new _dateCalculator2.default(2017);
  ...
  describe('the `isValidRangeBarData` method', function () {
    it('should check whether the provided start and end dates are valid, to create a range bar', function () {
      var plugin = new _dateCalculator2.default(2017);
  ...
  describe('the `calculateMonthData` method', function () {
    it('should return the object containing information about all the months', function () {
      var plugin = new _dateCalculator2.default(2017);
      var expectedResult = [{ name: 'January', days: 31 }, { name: 'February', days: 28 }, { name: 'March', days: 31 }, { name: 'April', days: 30 }, { name: 'May', days: 31 }, { name: 'June', days: 30 }, { name: 'July', days: 31 }, { name: 'August', days: 31 }, { name: 'September', days: 30 }, { name: 'October', days: 31 }, { name: 'November', days: 30 }, { name: 'December', days: 31 }];

      expect(JSON.stringify(plugin.calculateMonthData())).toEqual(JSON.stringify(expectedResult));
    });
  });

  describe('the `calculateWeekStructure` method', function () {
    it('should modify the `monthList` property of the plugin with the month/week structure', function () {
      var plugin = new _dateCalculator2.default(2017);
      ...
      var monthList = plugin.monthList;
    ...
    it('should modify the `monthList` property of the plugin with the month/week structure, with `allowSplitWeeks` disabled', function () {
      var plugin = new _dateCalculator2.default(2017, false);
