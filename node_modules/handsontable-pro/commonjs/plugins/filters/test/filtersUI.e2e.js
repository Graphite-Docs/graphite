...
describe('Filters UI', function () {
  ...
  describe('Conditional component', function () {
    ...
    it('should disappear dropdown menu after hitting ESC key in conditional component ' + 'which don\'t show other input and focus is loosen #86', function (done) {
      handsontable({
        data: getDataForFilters(),
        columns: getColumnsForFilters(),
        filters: true,
    ...
    it('should work properly when user added condition with too many arguments #179', _asyncToGenerator(function* () {
    ...
    describe('Updating "by value" component cache #87', function () {
      it('should update component view after applying filtering and changing cell value', function () {
        handsontable({
          ...
          columns: [{ data: 'id', type: 'numeric', title: 'ID' }, { data: 'name', type: 'text', title: 'Full name' }, { data: 'address', type: 'text', title: 'Address' }],
          dropdownMenu: true,
          filters: true,
          width: 500,
          height: 300
  ...
  describe('Advanced filtering (conditions and operations combination #160)', function () {
    ...
    it('should filter data properly after changing operator ' + '(`conjunction` <-> `disjunction` operation)', function (done) {
      handsontable({
        data: getDataForFilters(),
        columns: getColumnsForFilters(),
        dropdownMenu: true,
  ...
  describe('Advanced filtering (conditions, operations and "by value" component #160)', function () {
    it('First conditional chosen -> filter operation -> unchecked first value from multiple select -> ' + 'selected `disjunction` operation -> filter operation', function (done) {
      handsontable({
        data: getDataForFilters(),
        columns: getColumnsForFilters(),
        dropdownMenu: true,
    ...
    it('Two conditionals chosen -> filter operation -> unchecked first value from multiple select ' + '-> filter operation', function (done) {
      handsontable({
        data: getDataForFilters(),
        columns: getColumnsForFilters(),
        dropdownMenu: true,
