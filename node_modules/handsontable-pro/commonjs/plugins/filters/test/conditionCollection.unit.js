...
var _conditionCollection = require('handsontable-pro/plugins/filters/conditionCollection');
...
var _constants = require('handsontable-pro/plugins/filters/constants');
...
describe('ConditionCollection', function () {
  it('should be initialized and accessible from the plugin', function () {
    expect(_conditionCollection2.default).toBeDefined();
  });

  it('should create empty bucket for conditions, columnTypes and empty orderStack', function () {
    var conditionCollection = new _conditionCollection2.default();

    expect(conditionCollection.conditions).toEqual(jasmine.any(Object));
    expect(Object.keys(conditionCollection.conditions)).toEqual(Object.keys(_logicalOperationRegisterer.operations));
  ...
  describe('isMatch', function () {
    it('should check is value is matched to the conditions at specified column index', function () {
      var conditionCollection = new _conditionCollection2.default();
      conditionCollection.columnTypes = { 3: _constants.OPERATION_AND };
      var conditionMock = {};
      ...
      expect(conditionCollection.isMatchInConditions).toHaveBeenCalledWith([conditionMock], 'foo', _constants.OPERATION_AND);
      expect(result).toBe(true);
    });

    it('should check is value is matched to the conditions for all columns', function () {
      var conditionCollection = new _conditionCollection2.default();
      conditionCollection.columnTypes = { 3: _constants.OPERATION_AND, 13: _constants.OPERATION_AND };
      var conditionMock = {};
      var conditionMock2 = {};

      conditionCollection.conditions[_constants.OPERATION_AND]['3'] = [conditionMock];
      conditionCollection.conditions[_constants.OPERATION_AND]['13'] = [conditionMock2];
      ...
      expect(conditionCollection.isMatchInConditions.calls.argsFor(0)).toEqual([[conditionMock], 'foo', _constants.OPERATION_AND]);
      expect(conditionCollection.isMatchInConditions.calls.argsFor(1)).toEqual([[conditionMock2], 'foo', _constants.OPERATION_AND]);
      expect(result).toBe(true);
    });
  ...
  describe('isMatchInConditions', function () {
    ...
    describe('OPERATION_OR', function () {
      it('should check if one of conditions is matched to the value #1', function () {
        ...
        var result = conditionCollection.isMatchInConditions([conditionMock, conditionMock2], 'foo', _constants.OPERATION_OR);
      ...
      it('should break checking value when condition is matched to the value', function () {
        ...
        var result = conditionCollection.isMatchInConditions([conditionMock, conditionMock2, conditionMock3], 'foo', _constants.OPERATION_OR);
  ...
  describe('addCondition', function () {
    beforeEach(function () {
      _conditionRegisterer.conditions.eq = {
        condition: function condition() {},
        descriptor: {}
      };
      _conditionRegisterer.conditions.contains = {
        condition: function condition() {},
        descriptor: {}
      };
    });
    ...
    afterEach(function () {
      delete _conditionRegisterer.conditions.eq;
      delete _conditionRegisterer.conditions.contains;
    });

    it('should trigger `beforeAdd` and `afterAdd` hook on adding condition', function () {
      var conditionCollection = new _conditionCollection2.default();
      var conditionMock = { args: [], command: { key: 'eq' } };
    ...
    it('should add condition to the collection at specified column index.', function () {
      var conditionCollection = new _conditionCollection2.default();
      var conditionMock = { args: [1], command: { key: 'eq' } };

      conditionCollection.addCondition(3, conditionMock);

      expect(conditionCollection.conditions[_constants.OPERATION_AND]['3'].length).toBe(1);
      expect(conditionCollection.conditions[_constants.OPERATION_AND]['3'][0].name).toBe('eq');
      expect(conditionCollection.conditions[_constants.OPERATION_AND]['3'][0].args).toEqual([1]);
      expect(conditionCollection.conditions[_constants.OPERATION_AND]['3'][0].func instanceof Function).toBe(true);
    });

    it('should allow to add few condition under the same name and column index #160', function () {
      var conditionCollection = new _conditionCollection2.default();
      var conditionMock = { args: ['A'], command: { key: 'contains' } };
      var conditionMock2 = { args: ['B'], command: { key: 'contains' } };
      var conditionMock3 = { args: ['C'], command: { key: 'contains' } };

      conditionCollection.addCondition(3, conditionMock);
      conditionCollection.addCondition(3, conditionMock2);
      conditionCollection.addCondition(3, conditionMock3);

      expect(conditionCollection.conditions[_constants.OPERATION_AND]['3'].length).toBe(3);
    });
    ...
    it('should allow to add few condition under the same column index ' + 'only when they are related to the same operation (throw exception otherwise) #160', function () {
      ...
      conditionCollection.addCondition(3, conditionMock, _constants.OPERATION_AND);
      conditionCollection.addCondition(3, conditionMock2, _constants.OPERATION_AND);
      expect(function () {
        conditionCollection.addCondition(3, conditionMock3, _constants.OPERATION_OR);
  ...
  describe('exportAllConditions', function () {
    it('should return an empty array when no conditions was added', function () {
      ...
      var conditions = conditionCollection.exportAllConditions();
    ...
    it('should return conditions as an array of objects for all column in the same order as it was added', function () {
      var conditionCollection = new _conditionCollection2.default();
      var conditionMock = { name: 'begins_with', args: ['c'] };
      var conditionMock1 = { name: 'date_tomorrow', args: [] };
      var conditionMock2 = { name: 'eq', args: ['z'] };

      conditionCollection.orderStack = [6, 1, 3];
      conditionCollection.columnTypes = { 1: _constants.OPERATION_AND, 3: _constants.OPERATION_AND, 6: _constants.OPERATION_AND };
      conditionCollection.conditions[_constants.OPERATION_AND]['3'] = [conditionMock];
      conditionCollection.conditions[_constants.OPERATION_AND]['6'] = [conditionMock1];
      conditionCollection.conditions[_constants.OPERATION_AND]['1'] = [conditionMock2];
  ...
  describe('hasConditions', function () {
    ...
    it('should return `true` if at specified column index condition were found under its name', function () {
      var conditionCollection = new _conditionCollection2.default();
      conditionCollection.columnTypes = { 3: _constants.OPERATION_AND };
      var conditionsMock = [{ name: 'lte' }, { name: 'eq' }];
  ...
  describe('destroy', function () {
    it('should nullable all properties', function () {
      ...
      conditionCollection.conditions[_constants.OPERATION_AND] = { 0: [], 2: [] };
      conditionCollection.conditions[_constants.OPERATION_OR] = { 3: [], 4: [] };
