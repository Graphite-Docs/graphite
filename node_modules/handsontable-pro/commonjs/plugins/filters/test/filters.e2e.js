...
describe('Filters', function () {
  ...
  it('should warn user by log at console when amount of conditions at specific column exceed the capability of ' + 'a dropdown menu (`dropdownMenu` plugin is enabled)', function () {
  ...
  it('should not warn user by log at console when amount of conditions at specific column not exceed the capability of ' + 'a dropdown menu (`dropdownMenu` plugin is enabled)', function () {
    console.warn = jasmine.createSpy('warn');
  ...
  it('should not warn user by log at console when amount of conditions at specific column exceed the capability of ' + 'a dropdown menu (`dropdownMenu` plugin is disabled)', function () {
    console.warn = jasmine.createSpy('warn');
  ...
  describe('Advanced filtering (conditions and operations combination #160)', function () {
    ...
    it('should filter values when more than one type of condition is used ' + '(multiple columns & two different operations)', function () {
      var hot = handsontable({
        data: getDataForFilters(),
        columns: getColumnsForFilters(),
        dropdownMenu: true,
