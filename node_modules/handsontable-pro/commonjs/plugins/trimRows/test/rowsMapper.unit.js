...
var _rowsMapper = require('handsontable-pro/plugins/trimRows/rowsMapper');
...
describe('TrimRows -> RowsMapper', function () {
  it('should set trimRows plugin while constructing', function () {
    var trimRowsMock = {};
    var mapper = new _rowsMapper2.default(trimRowsMock);
  ...
  it('should call isTrimmed method "length" times', function () {
    var trimRowsMock = {
      isTrimmed: function isTrimmed(index) {
        return false;
      }
    };
    var mapper = new _rowsMapper2.default(trimRowsMock);
