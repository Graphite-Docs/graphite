...
function shimSelectionProperties(instance) {
  if (instance.selections[0]) {
    instance.selections.getCell = function () {
      return instance.selections[0];
    };
  }
  if (instance.selections[1]) {
    instance.selections.createOrGetArea = function () {
      return instance.selections[1];
    };
    instance.selections.getAreas = function () {
      return [instance.selections[1]];
    };
  }
  if (instance.selections[2]) {
    instance.selections.createOrGetHeader = function () {
      return instance.selections[2];
    };
  }
  if (instance.selections[3]) {
    instance.selections.getFill = function () {
      return instance.selections[3];
    };
  }
