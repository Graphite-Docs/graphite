  ...
  _createClass(Highlight, [{
    ...
    value: function createOrGetArea() {
      ...
      if (this.areas.has(layerLevel)) {
        ...
        area = createHighlight(AREA_TYPE, Object.assign({ layerLevel: layerLevel }, this.options));
    ...
    value: function createOrGetHeader() {
      ...
      if (this.headers.has(layerLevel)) {
        ...
        header = createHighlight(HEADER_TYPE, Object.assign({}, this.options));
    ...
    value: function clear() {
      ...
      arrayEach(this.areas.values(), function (area) {
        area.clear();
      });
      arrayEach(this.headers.values(), function (header) {
        header.clear();
      });
    }
