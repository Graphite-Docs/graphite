    ...
    value: function appear(corners) {
      ...
      if (isMobileBrowser() || !cornerVisibleSetting || this.isPartRange(checkRow, checkCol)) {
        ...
        if (toColumn === this.wot.getSetting('totalColumns') - 1) {
          var cornerOverlappingContainer = toTD.offsetLeft + outerWidth(toTD) + parseInt(this.cornerDefaultStyle.width, 10) / 2 >= innerWidth(trimmingContainer);
        ...
        if (toRow === this.wot.getSetting('totalRows') - 1) {
          var _cornerOverlappingContainer = toTD.offsetTop + outerHeight(toTD) + parseInt(this.cornerDefaultStyle.height, 10) / 2 >= innerHeight(trimmingContainer);
