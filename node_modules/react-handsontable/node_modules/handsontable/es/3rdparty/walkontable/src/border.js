...
import { getComputedStyle, getTrimmingContainer, innerWidth, innerHeight, offset, outerHeight, outerWidth } from './../../../helpers/dom/element';
  ...
  _createClass(Border, [{
    ...
    value: function createMultipleSelectorHandles() {
      ...
      for (var _prop in handleStyle) {
        if (hasOwnProperty(handleStyle, _prop)) {
