...
function transactionTests() {
  ...
  (0, _tape2.default)('broadcastTransaction:\n    send via broadcast service with transaction to watch with default confs', function (t) {
    ...
    var confirmations = 6;
    _fetchMock2.default.post('https://broadcast.blockstack.org/v1/broadcast/transaction', {
      body: {
    ...
    _network.network.defaults.MAINNET_DEFAULT.broadcastTransaction(transaction, transactionToWatch).then(function () {
      t.assert(_fetchMock2.default.done());
    });
  });
  ...
  (0, _tape2.default)('broadcastTransaction:\n    rejects with error when broadcast service has a problem', function (t) {
    ...
    _fetchMock2.default.postOnce({
      name: 'Broadcast',
      matcher: function matcher(url, opts) {
        return url === 'https://broadcast.blockstack.org/v1/broadcast/transaction' && opts && opts.body === expectedBody;
      },
      response: {
        result: {},
        status: 500
  ...
  (0, _tape2.default)('broadcastTransaction: send immediately via utxo service', function (t) {
    ...
    _fetchMock2.default.postOnce({
      name: 'Broadcast',
      matcher: function matcher(url, opts) {
        return url === 'https://blockchain.info/pushtx?cors=true' && opts && opts.body;
      },
      response: {
  ...
  (0, _tape2.default)('broadcastZoneFile: send via broadcast service with transaction to watch', function (t) {
    ...
    _fetchMock2.default.postOnce({
      name: 'Broadcast',
      matcher: function matcher(url, opts) {
        return url === 'https://broadcast.blockstack.org/v1/broadcast/zone-file' && opts && opts.body === expectedBody;
      },
      response: {
        body: JSON.stringify({}),
        status: 202
  ...
  (0, _tape2.default)('broadcastZoneFile: rejects with error if core endpoint error', function (t) {
    ...
    _fetchMock2.default.restore();
    var zonefile = '$ORIGIN satoshi.id\n$TTL 3600\n_http._tcp	IN	URI	10	1	"https://example.com/satoshi.json"\n\n';
    var expectedBody = JSON.stringify({ zonefile: zonefile });

    _fetchMock2.default.postOnce({
      name: 'Broadcast',
      matcher: function matcher(url, opts) {
        return url === 'https://core.blockstack.org/v1/zonefile/' && opts.body === expectedBody;
      },
      response: {
  ...
  (0, _tape2.default)('broadcastZoneFile: send immediately via core atlas endpoint', function (t) {
    ...
    _fetchMock2.default.postOnce({
      name: 'Broadcast',
      matcher: function matcher(url, opts) {
        return url === 'https://core.blockstack.org/v1/zonefile/' && opts && opts.body === expectedBody;
      },
      response: {
        body: JSON.stringify({}),
        status: 202
  ...
  (0, _tape2.default)('broadcastNameRegistration', function (t) {
    ...
    _fetchMock2.default.postOnce({
      name: 'Broadcast',
      matcher: function matcher(url, opts) {
        return url === 'https://broadcast.blockstack.org/v1/broadcast/registration' && opts && opts.body === expectedBody;
      },
      response: {
        body: JSON.stringify({}),
        status: 202
  ...
  (0, _tape2.default)('getNamespaceBurnAddress: pay to namespace creator before year 1', function (t) {
    t.plan(1);
    _fetchMock2.default.restore();
    _fetchMock2.default.get('https://blockchain.info/latestblock?cors=true', { height: 601 });
    _fetchMock2.default.get('https://core.blockstack.org/v1/namespaces/test', { version: 2, address: BURN_ADDR, reveal_block: 600 });

    _network.network.defaults.MAINNET_DEFAULT.getNamespaceBurnAddress('test').then(function (baddr) {
      t.equal(baddr, BURN_ADDR, 'Pay to namespace creator in year 1');
    });
  });

  (0, _tape2.default)('getNamespaceBurnAddress: pay to burn address after year 1', function (t) {
    t.plan(1);
    _fetchMock2.default.restore();
    _fetchMock2.default.get('https://blockchain.info/latestblock?cors=true', { height: 600 + 52595 });
    _fetchMock2.default.get('https://core.blockstack.org/v1/namespaces/test', { version: 2, address: BURN_ADDR, reveal_block: 600 });
  ...
  (0, _tape2.default)('getNamespaceBurnAddress: pay to burn address after year 1', function (t) {
    t.plan(1);
    _fetchMock2.default.restore();
    _fetchMock2.default.get('https://blockchain.info/latestblock?cors=true', { height: 600 + 52595 + 1 });
    _fetchMock2.default.get('https://core.blockstack.org/v1/namespaces/test', { version: 2, address: BURN_ADDR, reveal_block: 600 });
...
function safetyTests() {
  (0, _tape2.default)('addCanReceiveName', function (t) {
    ...
    var namesWithSubdomains = new Array(25);
    namesWithSubdomains.fill('dummy.id');
    namesWithSubdomains[24] = 'dummy.dummy.id';
    _fetchMock2.default.get('https://core.blockstack.org/v1/addresses/bitcoin/' + testAddresses[2].address, { names: namesWithSubdomains });

    Promise.all([_lib.safety.addressCanReceiveName(testAddresses[0].address), _lib.safety.addressCanReceiveName(testAddresses[1].address), _lib.safety.addressCanReceiveName(testAddresses[2].address)]).then(function (_ref35) {
  ...
  (0, _tape2.default)('ownsName', function (t) {
    ...
    Promise.all([_lib.safety.ownsName('foo.test', testAddresses[0].address), _lib.safety.ownsName('foo.test', testAddresses[1].address)]).then(function (_ref37) {
  ...
  (0, _tape2.default)('nameInGracePeriod', function (t) {
    ...
    _fetchMock2.default.get('https://core.blockstack.org/v1/names/foo.test', { expire_block: 50 });
  ...
  (0, _tape2.default)('nameAvailable', function (t) {
    ...
    Promise.all([_lib.safety.isNameAvailable('foo.test'), _lib.safety.isNameAvailable('bar.test')]).then(function (_ref39) {
  ...
  (0, _tape2.default)('namespaceValid', function (t) {
    t.plan(8);
    ...
    var shouldFail = [{
      ...
      return _lib.safety.isNamespaceValid(x.namespaceID).then(function (passed) {
        return t.ok(!passed, x.namespaceID + ' should fail for : ' + x.reason);
      });
    });

    var shouldPass = ['0123456789abcdefghi', 'a-b-c', 'a_b_c'].map(function (x) {
      return _lib.safety.isNamespaceValid(x).then(function (passed) {
        return t.ok(passed, x + ' should pass');
      });
    });
  ...
  (0, _tape2.default)('namespaceAvailable', function (t) {
    t.plan(3);
    _fetchMock2.default.restore();
    _fetchMock2.default.get('https://core.blockstack.org/v1/namespaces/test', { body: 'Namespace available', status: 404 });
    _fetchMock2.default.get('https://core.blockstack.org/v1/namespaces/test2', { address: testAddresses[0].address });
    _fetchMock2.default.get('https://core.blockstack.org/v1/namespaces/test3', { body: 'Some error', status: 400 });

    var errorCheck = _lib.safety.isNamespaceAvailable('test3').then(function () {
      return false;
    }).catch(function () {
      return true;
    });
    Promise.all([_lib.safety.isNamespaceAvailable('test'), _lib.safety.isNamespaceAvailable('test2'), errorCheck]).then(function (_ref41) {
  ...
  (0, _tape2.default)('revealedNamespace', function (t) {
    t.plan(4);
    _fetchMock2.default.restore();
    _fetchMock2.default.get('https://core.blockstack.org/v1/namespaces/test', { recipient_address: testAddresses[0].address });
    _fetchMock2.default.get('https://core.blockstack.org/v1/namespaces/test2', { recipient_address: testAddresses[1].address });
    _fetchMock2.default.get('https://core.blockstack.org/v1/namespaces/test3', { body: 'Namespace not found', status: 404 });
    _fetchMock2.default.get('https://core.blockstack.org/v1/namespaces/test4', { body: 'Some error', status: 400 });

    var errorCheck = _lib.safety.revealedNamespace('test3', testAddresses[0].address).then(function () {
      return false;
    }).catch(function () {
      return true;
    });

    Promise.all([_lib.safety.revealedNamespace('test', testAddresses[0].address), _lib.safety.revealedNamespace('test2', testAddresses[0].address), _lib.safety.revealedNamespace('test3', testAddresses[0].address), errorCheck]).then(function (_ref43) {
  ...
  (0, _tape2.default)('namespaceIsReady', function (t) {
    t.plan(4);
    _fetchMock2.default.restore();
    _fetchMock2.default.get('https://core.blockstack.org/v1/namespaces/test', { ready: true });
    _fetchMock2.default.get('https://core.blockstack.org/v1/namespaces/test2', { ready: false });
    _fetchMock2.default.get('https://core.blockstack.org/v1/namespaces/test3', { body: 'Namespace not found', status: 404 });
    _fetchMock2.default.get('https://core.blockstack.org/v1/namespaces/test4', { body: 'Some other error', status: 400 });

    var errorCheck = Promise.resolve().then(function () {
      return false;
    }).catch(function () {
      return true;
    });

    Promise.all([_lib.safety.namespaceIsReady('test'), _lib.safety.namespaceIsReady('test2'), _lib.safety.namespaceIsReady('test3'), errorCheck]).then(function (_ref45) {
  ...
  (0, _tape2.default)('namespaceIsRevealed', function (t) {
    t.plan(4);
    _fetchMock2.default.restore();
    _fetchMock2.default.get('https://core.blockstack.org/v1/namespaces/test', { ready: false });
    _fetchMock2.default.get('https://core.blockstack.org/v1/namespaces/test2', { ready: true });
    _fetchMock2.default.get('https://core.blockstack.org/v1/namespaces/test3', { body: 'Namespace not found', status: 404 });
    _fetchMock2.default.get('https://core.blockstack.org/v1/namespaces/test4', { body: 'Some other error', status: 400 });
    ...
    Promise.all([_lib.safety.namespaceIsRevealed('test'), _lib.safety.namespaceIsRevealed('test2'), _lib.safety.namespaceIsRevealed('test3'), errorCheck]).then(function (_ref47) {
