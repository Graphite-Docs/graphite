...
var _proxyquire5 = require('proxyquire');

var _proxyquire6 = _interopRequireDefault(_proxyquire5);
...
function runStorageTests() {
  (0, _tape2.default)('getFile unencrypted', function (t) {
    ...
    var _proxyquire = (0, _proxyquire6.default)('../../../lib/storage', { // eslint-disable-line no-shadow
  ...
  (0, _tape2.default)('getFile unencrypted - multi-reader', function (t) {
    ...
    var _proxyquire2 = (0, _proxyquire6.default)('../../../lib/storage', { // eslint-disable-line no-shadow
    ...
    var nameLookupUrl = 'http://localhost:6270/v1/names/yukan.id';
  ...
  (0, _tape2.default)('putFile unencrypted', function (t) {
    ...
    var _proxyquire3 = (0, _proxyquire6.default)('../../../lib/storage', {
    ...
    putFile(path, fileContent).then(function (publicURL) {
  ...
  (0, _tape2.default)('getUserAppFileUrl', function (t) {
    ...
    var _proxyquire4 = (0, _proxyquire6.default)('../../../lib/storage', {
      '../profiles': { lookupProfile: lookupProfile }
    }),
        getUserAppFileUrl = _proxyquire4.getUserAppFileUrl;
